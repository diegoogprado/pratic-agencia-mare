...
export default function Section3() {
    const carousels = [
        "../../public/assets/OT1.png",
        "../../public/assets/OT2.png",
        "../../public/assets/OT3.png",
        "../../public/assets/OT4.png",
        "../../public/assets/OT5.png",
        "../../public/assets/OT6.png"
    ]
    return (
        <section id="recWork" className="recentWorks">
            ...
            <div className="workContent">
                <div className="contentImg">
                    <img src="../../public/assets/leftImg.png" alt="" />
                </div>
                <div className="contentText">
                    ...
                    <div className="distacNLogo">
                        ...
                        <span className="borderLogo"><img src="../../public/assets/logo morley.png" alt="" /></span>
                    </div>
                </div>
            </div>
            <div className="workContent">
                <div className="contentText">
                    ...
                    <div className="distacNLogo">
                        ...
                        <span className="borderLogo"><img src="../../public/assets/logoAdobe.png" alt="" /></span>
                    </div>
                </div>
                <div className="contentImg">
                    <img src="../../public/assets/rightImg.png" alt="" />
                </div>
            </div>
